...
const AddPostForm = ({
  ...
  const handleAddPost = async (values, { setSubmitting }) => {
    try {
      ...
      dispatch(notify('Posted!', 'success'));
    } catch (err) {
      setSubmitting(false);
          ...
          <Form className={classes.form}>
                  ...
                  <TextField
                    ...
                    label={
                      actionType === 'edit'
                        ...
                        : !fromSubreddit
                        ? 'Select a subreggit to add this post to'
            ...
            {values.postType === 'Text' && (
              <div className={classes.textInput}>
                ...
                <TextInput
                  name="textSubmission"
                  placeholder={`Add post...use HTML tags like this - "<p>I am on reggit<p>" to enahnce your post`}
                  multiline
                  label="Your post"
            ...
            {values.postType === 'Image' && (
              <div className={classes.imageInput}>
                <div className={classes.imageBtnsWrapper}>
                  ...
                  >
                    {values.imageSubmission
                      ? `${isMobile ? '' : 'You have hosen '}"${fileName}"`
                      : `Upload Image`}
                  </Button>
                  {values.imageSubmission && (
                    <IconButton
